...
class ChatSession(models.Model):
    ...
    first_prevailing_emotion = models.ForeignKey("Emotion", related_name="first_prevailing_emotion",
                                                 on_delete=models.DO_NOTHING)
    second_prevailing_emotion = models.ForeignKey("Emotion", related_name="second_prevailing_emotion",
                                                  on_delete=models.DO_NOTHING)
...
class EmployeePrize(models.Model):
    ...
    def __str__(self) -> str:
        return f"{'employee' + str(self.employee) + ' prize:' + str(self.prize) + ' date:' + str(self.date)}"
